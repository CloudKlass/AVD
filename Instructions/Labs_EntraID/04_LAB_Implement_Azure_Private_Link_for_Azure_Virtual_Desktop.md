...
1. From the lab computer, in the web browser displaying the Azure portal, search for and select **Virtual machines**, in **Computer infrastructure** | Virtual machines select "az140-111e-vm0", fromthe top menu select stop.
