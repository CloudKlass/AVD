...
1. On the **Workspace** tab of the **Create a host pool** blade, confirm the following setting and select **Review + create**:
...
1. On the **Add application** blade, specify the following settings and select **Review + add**, then select **Add**:
...
1. On the **Applications** tab of the **Create an application group** blade, select **+ Add applications**.
1. On the **Add application** blade, on the **Basics** tab, specify the following settings and select **Next**:
